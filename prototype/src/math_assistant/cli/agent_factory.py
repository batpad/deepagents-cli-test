...
from .math_tools import add, subtract, get_tool_description
...
class PromptManager:
    ...
    def __init__(self, prompts_dir: Optional[Path] = None):
        if prompts_dir is None:
            prompts_dir = Path(__file__).parent.parent.parent.parent / "optimized_prompts"
...
class MathAgentFactory:
    ...
    def create_math_agent(self):
        ...
        try:
            ...
            # Add math tools to the agent's context
            # Note: DeepAgents will handle tool calling through its built-in mechanisms
            # The optimized prompt should guide the agent to reason about using tools
