...
import dspy
from ..cli.math_tools import add, subtract
...
class MathOptimizer:
    ...
    def __init__(self, model_name: str = "openai/gpt-4"):
        ...
        self.dataset_path = Path(__file__).parent.parent.parent.parent / "datasets" / "math_assistant" / "examples.json"
        self.output_dir = Path(__file__).parent.parent.parent.parent / "optimized_prompts"
    ...
    def math_accuracy_metric(self, prediction, example):
        ...
        import sys
        sys.path.append(str(self.dataset_path.parent))
